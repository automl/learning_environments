...
def train_td3(init_episodes, max_episodes):
    config = create_td3_config_base(
        init_episodes=init_episodes, max_episodes=max_episodes
    )
    seed = config["seed"]
...
def test_td3_quick():
    ...
    episode_rewards = train_td3(init_episodes=3, max_episodes=6)
...
def test_td3_complete():
    ...
    episode_rewards = train_td3(init_episodes=100, max_episodes=200)
