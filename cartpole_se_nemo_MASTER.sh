...
PYTHON_SCRIPT="GTNC_evaluate_cartpole.py"
...
# CALL
/home/fr/fr_fr/fr_as1464/anaconda3/envs/nemo_SE_CPU/bin/python -u $PWD/$PYTHON_SCRIPT $BOHB_ID 1

### OLD: /home/fr/fr_fr/fr_as1464/anaconda3/envs/nemo_SE_CPU/bin/python -u /work/ws/nemo/fr_as1464-se_port_ws-0/learning_environments-master/GTNC_evaluate_cartpole.py --bohb_id $BOHB_ID --id $ID --moab_id $MOAB_JOBID --port $PORT --min_workers $MIN_WORKER --number_workers $NUMBER_OF_WORKERS --mode $RUN_MODE
