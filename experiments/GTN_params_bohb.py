...
class ExperimentWrapper():
    ...
    def get_configspace(self):
        ...
        cs.add_hyperparameter(CSH.UniformIntegerHyperparameter(name='gtn_different_envs', lower=1, upper=3, log=False, default_value=1))
        ...
        cs.add_hyperparameter(CSH.UniformIntegerHyperparameter(name='em_batch_size', lower=64, upper=1024, log=True, default_value=256))
