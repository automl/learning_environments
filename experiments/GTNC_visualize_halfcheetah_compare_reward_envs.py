...
LOG_FILES = ['../results/halfcheetah_compare_reward_envs/best5_0.pt',
             '../results/halfcheetah_compare_reward_envs/best5_2.pt',
             '../results/halfcheetah_compare_reward_envs/best5_4.pt',
             '../results/halfcheetah_compare_reward_envs/best5_102.pt']
...
def plot_data(proc_data, savefig_name):
    ...
    plt.legend(('baseline naive','NN w/o info vector','NN w/ info vector','baseline Kaust'))
    plt.xlim(0,99)
