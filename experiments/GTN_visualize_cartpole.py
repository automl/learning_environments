...
def compare_env_output(virtual_env, replay_buffer):
    ...
    virt_rewards_incorrect = torch.zeros_like(rewards)
    ...
    for i in range(len(diff_next_states[0])):
        ...
        plot_hist(h1=reals,
                  h2=virts,
                  h1l='real environment',
                  h2l='virtual environment',
                  xlabel=plot_name)
...
if __name__ == "__main__":
    ...
    file_name = 'cartpole_good_21_L5OV5M.pt'
    ...
    compare_env_output(virtual_env, replay_buffer_test_all)
