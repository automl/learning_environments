...
LOG_FILES = ['../results/thomas_results/cmc_compare_reward_envs/best_transfer_algo1.pt',
             '../results/thomas_results/cmc_compare_reward_envs/best_transfer_algo2.pt',
             '../results/thomas_results/cmc_compare_reward_envs/best_transfer_algo5.pt',
             '../results/thomas_results/cmc_compare_reward_envs/best_transfer_algo6.pt',
             '../results/thomas_results/cmc_compare_reward_envs/best_transfer_algo0.pt',
             '../results/thomas_results/cmc_compare_reward_envs/best_transfer_algo-1.pt']
