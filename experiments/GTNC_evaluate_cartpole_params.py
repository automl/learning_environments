...
class ExperimentWrapper():
    ...
    def get_configspace(self):
        ...
        cs.add_hyperparameter(CSH.UniformFloatHyperparameter(name='ddqn_tau', lower=0.003, upper=0.03, log=True, default_value=0.01))
        cs.add_hyperparameter(CSH.UniformFloatHyperparameter(name='ddqn_eps_init', lower=0.5, upper=1, log=True, default_value=0.75))
        cs.add_hyperparameter(CSH.UniformFloatHyperparameter(name='ddqn_eps_min', lower=0.01, upper=0.1, log=True, default_value=0.05))
