...
class ExperimentWrapper():
    ...
    def get_configspace(self):
        ...
        cs.add_hyperparameter(CSH.UniformFloatHyperparameter(name='td3_action_std', lower=0.1, upper=0.5, log=True, default_value=0.2))
        ...
        cs.add_hyperparameter(CSH.UniformFloatHyperparameter(name='td3_match_weight_actor', lower=1e-3, upper=1e9, log=True, default_value=1e3))
        cs.add_hyperparameter(CSH.UniformFloatHyperparameter(name='td3_match_weight_critic', lower=1e-3, upper=1e9, log=True, default_value=1e3))
    ...
    def get_specific_config(self, cso, default_config, budget):
        ...
        config["agents"]["td3"]["match_delay"] = cso["td3_match_delay"]
