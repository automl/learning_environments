...
class GTN_Worker(GTN_Base):
    ...
    def read_worker_input(self):
        print("worker.sync_dir ", self.sync_dir)
    ...
    def calc_score(self, env, time_remaining):
        ...
        print("WORKER -> calc_score(..): reward_list_train, episode_length_train: ", reward_list_train, episode_length_train)
